...
### Settings Table
**Purpose:** Store application settings and configuration values for all services, providing centralized configuration management.
...
('General', 'DB_HOST', 'localhost', 'Database host address'),
...
('Gateway', 'SESSION_SERVICE_URL', 'http://localhost:8081', 'URL for session service'),
('Gateway', 'ORDERS_SERVICE_URL', 'http://localhost:8083', 'URL for orders service'),
('Gateway', 'INVENTORY_SERVICE_URL', 'http://localhost:8084', 'URL for inventory service'),
('Gateway', 'INVOICE_SERVICE_URL', 'http://localhost:8085', 'URL for invoice service'),
...
('Invoice', 'INVENTORY_SERVICE_URL', 'http://localhost:8084', 'URL for inventory service'),
...
**Field Descriptions:**
- `setting_id`: Primary key, UUID (auto-generated)
- `service`: Service name the setting belongs to (General, Gateway, Session, Orders, Inventory, Invoice, Data, UI)
