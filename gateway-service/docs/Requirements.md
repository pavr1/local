...
### Existences
**Description:** Track individual ingredient purchases/acquisitions from suppliers or supermarkets. Each existence represents a specific purchase batch with invoice traceability and expiration tracking.
...
- **Business Logic:**
  ...
  - Purchase date and supplier information accessed through invoice relationship via invoice items
  - Different ingredients on same invoice can have different expiration dates through invoice items
...
- **Invoice Attributes:**
  - **Invoice Number:** Unique identifier for the invoice/invoice
  ...
  - **Total Amount:** Monetary amount of the invoice/invoice (calculated from invoice items)
  - **Image Upload:** Mandatory invoice/invoice image documentation
  - **Notes:** Additional notes about the purchase

- **Invoice Item Attributes:**
  - **Invoice Reference:** Link to parent invoice
...
- **Digital Invoice Requirements:**
  - All invoices must include digital invoice image upload
  - Supported formats: JPG, PNG, PDF
  - Mandatory documentation for expense validation
  - Each invoice is directly linked to an expense category
...
### Invoices
**Description:** Purchase invoice/invoice management system that tracks purchases from suppliers or supermarkets. Each invoice represents a complete purchase transaction with main information.

- **Attributes:**
  - **Invoice Number** (string): Invoice/invoice number (unique)
  ...
  - **Total Amount** (decimal): Total amount of the invoice/invoice (calculated from invoice items)
  - **Image URL** (string): URL/path to uploaded invoice/invoice image (mandatory)
  - **Notes** (text, nullable): Additional notes about the purchase

- **Business Logic:**
  - One invoice can contain multiple invoice items (line items)
...
### Invoice Items
**Description:** Individual line items/details for each invoice, acting as expense line items that detail the expenses within a invoice.

- **Attributes:**
  - **Invoice Reference** (foreign key): Link to parent invoice
...
- **Business Logic:**
  ...
  - Supports detailed expense breakdown within invoices
